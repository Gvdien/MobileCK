 ...
 * Use the {@link DoxangFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class DoxangFragment extends Fragment {
     ...
     * @return A new instance of fragment DoxangFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static DoxangFragment newInstance(String param1, String param2) {
        DoxangFragment fragment = new DoxangFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_doxang, container, false);
        rvDoxang = view.findViewById(R.id.rvDoxang);
        getData();
        rvDoxang.setLayoutManager(new LinearLayoutManager(getContext()));
