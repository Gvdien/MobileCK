 ...
 * Use the {@link ThaynhotFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ThaynhotFragment extends Fragment {
     ...
     * @return A new instance of fragment ThaynhotFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ThaynhotFragment newInstance(String param1, String param2) {
        ThaynhotFragment fragment = new ThaynhotFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_thaynhot, container, false);
        rvThaynhot = view.findViewById(R.id.rvThaynhot);
        getData();
        rvThaynhot.setLayoutManager(new LinearLayoutManager(getContext()));
